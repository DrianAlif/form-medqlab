...
export function AkomodasiPreview({ data }) {
  ...
  // Minimum 5 table rows for balanced template layout
  const displayRowsCount = Math.max(items.length, 5);
  ...
  return (
    <div id="pdf-export-container" className="w-full flex flex-col items-center gap-8 print:gap-0 font-sans">
      {/* LEMBAR 1: FORMULIR LAPORAN AKOMODASI (Landscape A4: 1122px x 794px) */}
      <div className="pdf-sheet pdf-page-landscape text-black text-[10px]">
        <div className="page-inner-content flex flex-col justify-between h-full">
          <div>
            {/* Header Bar */}
            <div className="flex items-center justify-between pb-2.5 mb-2 border-b border-black">
          ...
          <div className="no-break grid grid-cols-12 gap-6 items-start mt-2">
            ...
            <div className="col-span-7 flex flex-col justify-between min-h-[130px] signature-section">
              <div className="text-right text-[10px] font-semibold pr-3 pb-1">
            ...
            <div className="grid grid-cols-2 gap-4 flex-1">
              {chunk.map((att, idx) => {
                ...
                return (
                  ...
                  >
                    <div className="w-full flex-1 flex items-center justify-center p-1 bg-slate-50 rounded-lg overflow-hidden border border-slate-100 max-h-[250px]">
                      <img
                        src={att.dataUrl}
                        alt={att.caption || `Bukti ${globalIndex}`}
                        className="attachment-img max-h-[235px] w-full"
                      />
                    </div>
